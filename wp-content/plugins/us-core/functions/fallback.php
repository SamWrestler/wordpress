...
/**
 * This file applies fallback functions for theme elements
...
// Inner Row in Live Builder
if ( ! function_exists( 'usb_fallback_vc_row_inner' ) ) {
	add_filter( 'us_edit_atts_fallback_vc_row_inner', 'usb_fallback_vc_row_inner', 800, 2 );
