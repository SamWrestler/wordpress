...
$items_layout_description .= '<a href="' . admin_url() . 'post-new.php?post_type=us_grid_layout" target="_blank">';
...
$appearance_params = array(
	...
	'overriding_link' => array(
		...
		'link_additional_values' => array(
			...
			'popup_post' => __( 'Open Post in popup', 'us' ),
			'popup_image' => __( 'Open Post Image in popup', 'us' ),
